...
if "%1" == "all" (
	...
	gcc -o "build\en-US\ShutdownGuard\ShutdownGuard.exe" shutdownguard.c build\resources.o -mwindows -lshlwapi -lwininet -lpsapi -march=pentium2 -O2
	if not exist "build\en-US\ShutdownGuard\ShutdownGuard.exe" (
		exit /b
	)
	strip "build\en-US\ShutdownGuard\ShutdownGuard.exe"
	gcc -o "build\en-US\ShutdownGuard\patch.dll" patch.c build\resources_patch.o -mdll -march=pentium2 -O2
	...
	gcc -o ShutdownGuard.exe shutdownguard.c build\resources.o -mwindows -lshlwapi -lwininet -lpsapi -march=pentium2 -DDEBUG
	gcc -o patch.dll patch.c build\resources_patch.o -mdll -march=pentium2 -DDEBUG
